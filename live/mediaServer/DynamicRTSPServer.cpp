...
static ServerMediaSession* createNewSMS(UsageEnvironment& env,
  ...
  }else if (strcmp(extension,".g711") == 0) {
    // Assumed to be an G711 Audio file:
    NEW_SMS("G711 Audio");
    sms->addSubsession(G711AudioFileServerMediaSubsession::createNew(env, fileName, reuseSource));
